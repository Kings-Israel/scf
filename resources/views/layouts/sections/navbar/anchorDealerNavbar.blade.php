...
$active_company = \App\Models\Company::find(Auth::user()->activeAnchorDealerCompany()->first()->company_id);
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item mx-2">
            <div class="">
              ...
              @if (!auth()->user()->activeAnchorDealerCompany)
                @php(auth()->user()->activeAnchorDealerCompany()->create(['company_id' => $companies->first()->id]))
              @endif
              @php($current_company = auth()->user()->activeAnchorDealerCompany->company_id)
              <form action="{{ route('anchor.dealer.company.switch') }}" method="post" id="company-switch-form">
                @csrf
          ...
          <li class="nav-item me-2 me-xl-0">
            <a class="nav-link hide-arrow" href="{{ route('anchor.dealer-help-index') }}" target="_blank">
          ...
          <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
            <a class="nav-link hide-arrow" href="{{ route('anchor.dealer-notifications') }}">
