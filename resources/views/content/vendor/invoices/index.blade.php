...
<div class="d-flex justify-content-between">
  ...
  <div class="d-flex gap-2">
    @can('Upload Invoices')
      <div id="vendor-invoices-upload">
        <vendor-invoices-upload></vendor-invoices-upload>
      </div>
    @endcan
    <div>
      <button class="btn btn-primary">
        <a href="{{ route('vendor.invoices.uploaded') }}" class="text-white">{{ __('View Uploaded Status') }}</a>
      </button>
    </div>
  </div>
</div>
...
<div class="nav-align-top nav-tabs-shadow mt-2">
  ...
  <div class="tab-content">
    <div class="tab-pane fade show active" id="navs-all-invoices" role="tabpanel">
      <!-- Invoice List Table -->
      <div id="vendor-all-invoices">
        <vendor-all-invoices-component can_replicate={{ auth()->user()->hasPermissionTo('Replicate Invoice') }}></vendor-all-invoices-component>
      </div>
    </div>
    <div class="tab-pane fade show" id="navs-pending-invoices" role="tabpanel">
      <div id="vendor-pending-invoices">
        <vendor-pending-invoices-component can_replicate={{ auth()->user()->hasPermissionTo('Replicate Invoice') }}></vendor-pending-invoices-component>
      </div>
    </div>
  </div>
</div>
