...
<script>
  ...
  //     earningReportsChart['rejected_invoices_data']
  //   );
  ...
  document.getElementById('total-utilized-limit').innerHTML = new Intl.NumberFormat().format(earningReportsChart.total_utilized_limit);
  ...
  let total_invoices = invoices.approved + invoices.closed + invoices.financed + invoices.disbursed + invoices.rejected + invoices.past_due;
...
<div class="row">
        ...
        <ul class="nav nav-tabs widget-nav-tabs pb-3 gap-4 mx-1 d-flex flex-nowrap" role="tablist">
          ...
          <li class="nav-item">
            <a href="javascript:void(0);" class="nav-link btn d-flex flex-column align-items-center justify-content-center" role="tab" data-bs-toggle="tab" data-bs-target="#navs-profit-id" aria-controls="navs-profit-id" aria-selected="false">
              <h6 class="tab-widget-title mb-0 mt-2">{{ __('Amount Paid')}}</h6>
            </a>
          </li>
        </ul>
  ...
  @can('Request Vendor Finance')
    <div id="vendor-cash-planner-eligible-invoices" class="mt-2">
