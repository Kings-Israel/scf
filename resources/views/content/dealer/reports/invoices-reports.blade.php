...
<script>
  ...
  $(document).ready(function () {
    data = $.ajax({
      url: 'dashboard/data', //? Use your own search api instead
      dataType: 'json',
      async: false
    }).responseJSON;
      ...
      <div class="card-header d-flex justify-content-between">
        ...
        <div class="timeline-filter-container p-0">
          ...
          <select class="form-select" id="timeline-filter" name="timeline_filter">
            <option value="past_5_years">{{ __('Past 5 Years')}}</option>
            <option value="past_3_years">{{ __('Past 3 Years')}}</option>
            <option value="past_year" selected>{{ __('Past Year')}}</option>
            <option value="past_6_months">{{ __('Past 6 Months')}}</option>
            <option value="past_3_months">{{ __('Past 3 Months')}}</option>
            <option value="past_month">{{ __('Past Month')}}</option>
          </select>
        </div>
      </div>
      <div class="card-body">
        ...
        <div class="d-flex align-items-start">
          <h5 class="card-title">{{ __('Financed Amounts (Past 12 Months)')}}</h5>
        </div>
