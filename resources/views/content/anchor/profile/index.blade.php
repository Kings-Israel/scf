  ...
  <div class="col-md-6 col-lg-4 mb-3">
    <div class="card">
      <div class="card-body">
        ...
        <h5><strong>{{ __('KRA PIN')}}: </strong><span class="fw-light">{{ $company->kra_pin }}</span></h5>
            ...
            @forelse ($company->documents as $key => $document)
              <div class="accordion-item card">
                ...
                <div id="accordionStyle1-{{ $key }}" class="accordion-collapse collapse" data-bs-parent="#accordionStyle1">
                  <div class="accordion-body">
                    <div class="d-flex">
                      <a href="{{ $document->path }}" target="_blank" class="btn btn-sm btn-success">View {{ $document->name }}</a>
                    </div>
                    @if ($document->rejected_reason)
                      <hr>
                      <h6>{{ __('Rejected Reason')}}</h6>
