...
<script>
  ...
  var earningReportsChart = $.ajax({
    url: 'dashboard/invoices/dealer/data', //? Use your own search api instead
    dataType: 'json',
    async: false
  }).responseJSON;
...
@if ($company->has_dealer_financing_programs)
  {{-- Dealers Statistics --}}
      ...
      <div class="card">
        <div class="card-body border-bottom border-primary">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2">{{ number_format($total_dealers_program_limit) }}</h5>
          </div>
          <h6>{{ __('Total Dealers Program Limit') }}</h6>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-6 mb-4">
      <div class="card">
        <div class="card-body border-bottom border-warning">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2">{{ number_format($dealers) }}</h5>
          </div>
          <h6>{{ __('No. of Dealers A/Cs') }}</h6>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-6 mb-4">
      <div class="card">
        <div class="card-body border-bottom border-info">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2">{{ number_format($total_dealers_utilized_amount, 2) }}</h5>
          </div>
          <h6>{{ __('Dealers Utilized Amount') }}</h6>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-6 mb-4">
      <div class="card">
        <div class="card-body border-bottom border-info">
          <div class="d-flex mb-2">
            <div class="badge p-2 bg-label-info"><i class="ti ti-clock ti-sm"></i></div>
            <h5 class="card-title px-2 my-2">{{ number_format($total_dealers_pipeline_amount, 2) }}</h5>
          </div>
          <h6>{{ __('Dealers Pipeline Amount') }}</h6>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-6 mb-4">
      <div class="card">
        <div class="card-body border-bottom border-warning">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2">{{ number_format($total_dealers_program_limit - $total_dealers_utilized_amount - $total_dealers_pipeline_amount, 2) }}</h5>
          </div>
          <h6>{{ __('Dealers Available Limit') }}</h6>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-6 mb-4">
      <div class="card">
        <div class="card-body border-bottom border-success">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2">{{ number_format($total_dealers_overdue_amount, 2) }}</h5>
          </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <ul class="nav nav-tabs widget-nav-tabs pb-3 gap-4 mx-1 d-flex flex-nowrap" role="tablist">
          ...
          <li class="nav-item">
            <a href="javascript:void(0);" class="nav-link btn d-flex flex-column align-items-center justify-content-center" role="tab" data-bs-toggle="tab" data-bs-target="#navs-closed-id" aria-controls="navs-sales-id" aria-selected="true">
