...
<div class="nav-align-top nav-tabs-shadow mb-4">
  ...
  <div class="tab-content">
    <div class="tab-pane fade show active" id="navs-purchase-orders" role="tabpanel">
      <div id="factoring_dealer_purchase_orders">
        <factoring-dealer-purchase-orders-component can_approve={{ auth()->user()->hasPermissionTo('Accept Dealer POs') ? 1 : 0 }}></factoring-dealer-purchase-orders-component>
      </div>
    </div>
    <div class="tab-pane fade show" id="navs-pending-approval" role="tabpanel">
      <div id="factoring_dealer_pending_purchase_orders">
        <factoring-dealer-pending-purchase-orders-component can_approve={{ auth()->user()->hasPermissionTo('Accept Dealer POs') ? 1 : 0 }}></factoring-dealer-pending-purchase-orders-component>
      </div>
    </div>
  </div>
</div>
