...
<script>
  ...
  document.getElementById('total-pipeline-amount').innerHTML = new Intl.NumberFormat().format(earningReportsChart['total_pipeline_amount']);
  ...
  // Donut Chart
  // --------------------------------------------------------------------
  let invoices = earningReportsChart['invoices']
...
@section('content')
<h4 class="fw-bold">
  <span class="fw-light">{{ __('Anchor Dashboard')}}</span>
</h4>
      ...
      <div class="card">
        <div class="card-body border-bottom border-primary">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2" id="total-program-limit">0</h5>
          </div>
      ...
      <div class="card">
        <div class="card-body border-bottom border-warning">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2" id="total-available-limit">0</h5>
          </div>
      ...
      <div class="card">
        <div class="card-body border-bottom border-info">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2" id="total-utilized-limit">0</h5>
          </div>
    ...
    <div class="col-lg-3 col-6 mb-4">
      <div class="card">
        <div class="card-body border-bottom border-info">
          <div class="d-flex mb-2">
            <div class="badge p-2 bg-label-info"><i class="ti ti-clock ti-sm"></i></div>
            <h5 class="card-title px-2 my-2" id="total-pipeline-amount">0</h5>
          </div>
      ...
      <div class="card">
        <div class="card-body border-bottom border-success">
          <div class="d-flex mb-2">
            ...
            <h5 class="card-title px-2 my-2" id="total-overdue-amount">0</h5>
          </div>
  ...
  <div class="col-md-3 col-12 mb-4">
    <div class="card h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div>
          <h5 class="card-title mb-0">{{ __('Invoices by Status')}}</h5>
        </div>
      </div>
      <div class="card-body">
