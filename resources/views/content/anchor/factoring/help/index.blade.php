  ...
  <div class="container-xl">
    <div class="row">
      <div class="col-lg-10 mx-auto mb-4">
        <div class="row">
          <div @if ($anchor_manual && $anchor_manual->vendor_user_manual) class="col-md-4 mb-md-0 mb-4" @else class="col-md-6 mb-md-0 mb-4" @endif>
            <div class="card border shadow-none">
              <div class="card-body text-center">
                ...
                <br>
                <p> {{ __('Feel Free to call us anytime. We are availabl')}}e 24/7</p>
              </div>
            </div>
          </div>
          ...
          @if ($anchor_manual && $anchor_manual->vendor_user_manual)
            <div class="col-md-4">
              <div class="card border shadow-none">
                <div class="card-body text-center">
                  <i class="ti ti-book ti-xl text-primary"></i>
                  <br>
                  <a href="{{ $anchor_manual->vendor_user_manual }}" target="_blank" class="my-2" style="font-size: 20px">{{ __('View Manual')}}</a>
                  <br>
                  <p> {{ __('This article will help you to understand the functionality of this dashboard')}} </p>
                </div>
              </div>
            </div>
          @endif
