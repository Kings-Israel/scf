...
<script>
  ...
  $(document).ready(function () {
    data = $.ajax({
      url: 'reports/data', //? Use your own search api instead
      dataType: 'json',
      async: false
    }).responseJSON;
  ...
  <div class="col-xl-4 col-md-4 col-6 mb-4">
    <div class="card h-100">
      <div class="card-header d-flex justify-content-between">
        <h5 class="mb-0 card-title">L{{ __('imit Utilization')}}</h5>
...
<div id="factoring_reports">
  <factoring-reports></factoring-reports>
</div>
