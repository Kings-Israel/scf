...
<div class="nav-align-top nav-tabs-shadow mb-4">
  ...
  <div class="tab-content">
    <div class="tab-pane fade show active" id="navs-purchase-orders" role="tabpanel">
      <div id="factoring_purchase_orders">
        <factoring-purchase-orders-component can_approve={{ auth()->user()->hasPermissionTo('Accept POs') ? 1 : 0 }}></factoring-purchase-orders-component>
      </div>
    </div>
    <div class="tab-pane fade show" id="navs-pending-approval" role="tabpanel">
      <div id="factoring_pending_purchase_orders">
        <factoring-pending-purchase-orders-component can_approve={{ auth()->user()->hasPermissionTo('Accept POs') ? 1 : 0 }}></factoring-pending-purchase-orders-component>
      </div>
    </div>
  </div>
</div>
