  ...
  <div class="col-12 mb-4">
    <div class="bs-stepper vertical wizard-vertical-icons-example mt-2">
      ...
      <div class="bs-stepper-content">
        <form method="POST" action="{{ route('anchor.factoring-invoices-update', ['invoice' => $invoice]) }}" enctype="multipart/form-data" id="invoice-form">
          @csrf
          <!-- Account Details -->
          <div id="account-details-vertical" class="content">
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                <select class="select2" id="buyer" name="buyer" required>
                  <option label=" "></option>
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <select class="form-select" id="credit_to_options" name="credit_to" required>
                      @foreach($vendor_bank_details as $vendor_bank)
                        <option value="{{ $vendor_bank->account_number }}" @if($vendor_bank->account_number == $invoice->credit_to) selected @endif>{{ $vendor_bank->account_number }}</option>
                      @endforeach
                    </select>
