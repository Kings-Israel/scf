...
<div class="d-flex justify-content-between">
  ...
  <div class="d-flex gap-2">
    @can('Upload Seller Invoices')
      <div id="factoring-invoices-upload">
        <factoring-invoices-upload></factoring-invoices-upload>
      </div>
    @endcan
    <div>
...
<div class="card">
  <!-- Invoice List Table -->
  <div id="factoring_invoices">
    <factoring-invoices-component can_create_invoice={!! $can_create_invoice !!}></factoring-invoices-component>
  </div>
</div>
@endsection
