...
<script>
  ...
  let default_payment_terms = {!! $max_days !!}

  var min_day = new Date(invoice.due_date)
  ...
  <div class="col-12 mb-4">
    <div class="bs-stepper vertical wizard-vertical-icons-example mt-2">
      ...
      <div class="bs-stepper-content">
        <form method="POST" action="{{ route('buyer.invoices.update', ['invoice' => $invoice]) }}" enctype="multipart/form-data" id="invoice-form">
          @csrf
          <!-- Account Details -->
              ...
              <div class="col-12 d-flex justify-content-between">
                ...
                <div class="d-flex">
                  <button class="btn btn-label-secondary mx-1">
                    <a href="{{ route('buyer.invoices.index') }}" class="align-middle d-sm-inline-block d-none">{{ __('Cancel')}}</a>
                  </button>
