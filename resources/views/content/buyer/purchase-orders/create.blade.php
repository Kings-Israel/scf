  ...
  <div class="col-12 mb-4">
    <div class="bs-stepper vertical wizard-vertical-icons-example mt-2">
      ...
      <div class="bs-stepper-content">
        <form method="POST" action="{{ route('buyer.purchase-orders.store') }}" enctype="multipart/form-data">
          @csrf
          <!-- Account Details -->
          <div id="account-details-vertical" class="content">
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                <input type="text" id="purchase_order_number" name="purchase_order_number" class="form-control" placeholder="PO Number" aria-label="purchase_order_number" value="{{ old('purchase_order_number') }}" required />
              ...
              <div class="col-sm-6">
                ...
                <select class="select2" id="vendor" name="company_id" required>
                  <option value="">{{ __('Select Anchor')}}</option>
              ...
              <div class="col-sm-6">
                ...
                <select class="select2" id="currency" name="currency" required>
                  ...
                  @foreach ($currencies as $currency)
                    <option value="{{ $currency->code }}" @if(old('currency') == $currency->code) selected @endif>{{ $currency->code }} ({{ $currency->name }})</option>
                  @endforeach
                </select>
              ...
              <div class="col-sm-3">
                ...
                <input class="form-control" type="date" name="duration_from" id="html5-date-input" value="{{ old('duration_from') }}" required />
              ...
              <div class="col-sm-3">
                ...
                <input class="form-control" type="date" name="duration_to" id="html5-date-input" value="{{ old('duration_to') }}" required />
              ...
              <div class="col-sm-6">
                ...
                <input type="text" id="delivery_address" name="delivery_address" class="form-control" placeholder="Delivery Address" aria-label="Delivery Address" required value="{{ old('delivery_address') }}" />
                <x-input-error :messages="$errors->get('delivery_address')" />
              </div>
              <div class="col-sm-6">
                <label class="form-label" for="invoice_payment_terms">{{ __('Invoice Payment Terms(Days)')}}</label>
                <input type="number" min="0" id="invoice_payment_terms" name="invoice_payment_terms" class="form-control" placeholder="Payment Terms" aria-label="invoice_payment_terms" />
              ...
              <div class="col-12">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" name="remarks" rows="2">{{ old('remarks') }}</textarea>
              ...
              <div class="col-12 row" id="items">
                ...
                <div class="col-sm-2">
                  ...
                  <input type="text" name="quantity[]" class="form-control" placeholder="0" id="quantity-0" oninput="updateTotal(0)" onblur="calculateInvoiceTotal()" aria-label="quantity" required />
                </div>
                <div class="col-sm-2">
                ...
                <div class="col-sm-2">
                  ...
                  <input type="text" name="price_per_quantity[]" class="form-control" id="price-0" placeholder="Ksh" oninput="updateTotal(0)" onblur="calculateInvoiceTotal()" aria-label="price_per_quantity" required />
                </div>
                <div class="col-sm-3">
              ...
              <div class="col-12 d-flex justify-content-end">
                <h6>{{ __('Total')}}:</h6>
                <h5 class="mx-4" id="total-invoice">0.00</h5>
              </div>
              <div class="d-flex justify-content-end">
                <button class="btn btn-primary"> <span class="align-middle d-sm-inline-block d-none me-sm-1">{{ __('Submit')}}</span></button>
              </div>
            </div>
          </div>
          <!-- Drafts -->
