  ...
  <div class="card p-2">
    <div class="d-flex flex-column flex-md-row justify-content-between">
      <div class="d-flex flex-wrap gap-1">
        <div class="">
          <label for="Sort by" class="form-label">{{ $t('Payment Ref No') }}</label>
          <input
        ...
        <div class="">
          <label for="Sort by" class="form-label">{{ $t('Invoice Number') }}</label>
          <input
            v-on:keyup.enter="filter"
            type="text"
            class="form-control form-search"
        ...
        <div class="">
          <label for="Sort by" class="form-label">{{ $t('Vendor') }}</label>
          <input
            v-on:keyup.enter="filter"
            type="text"
            class="form-control form-search"
        ...
        <div class="">
          <label for="Sort by" class="form-label">{{ $t('Anchor') }}</label>
          <input
            v-on:keyup.enter="filter"
            type="text"
            class="form-control form-search"
        ...
        <div class="">
          <label for="Sort by" class="form-label">{{ $t('Status') }}</label>
          <select
        ...
        <div class="">
          <label for="Sort by" class="form-label">{{ $t('Bulk Action') }}</label>
            ...
            <div class="modal-content">
              ...
              <form method="post" @submit.prevent="submitBulkAction('approve')">
                <div class="modal-body">
                  <div class="">
                    <h4>{{ $t('Are you sure you want to approve the selected vendor financing requests') }}?</h4>
                  </div>
        ...
        <div class="modal fade" id="bulk-rejection-modal" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">{{ $t('Update Vendor Financing Request') }}</h5>
                <button
                  type="button"
          ...
          <tr v-for="payment_request in requests.data" :key="payment_request.id">
            ...
            <td class="text-primary text-decoration-underline px-1" style="cursor: pointer">
              ...
              <i
                ...
                :title="'Program Limit is almost depleted. ' + payment_request.utilized_percentage_ratio + '% utilized'"
                v-if="payment_request.utilized_percentage_ratio > 90"
              ></i>
            </td>
            <td class="text-primary text-decoration-underline px-1" style="cursor: pointer">
              <a
            ...
            <td class="text-success px-1">
              {{ payment_request.currency }} {{ new Intl.NumberFormat().format(payment_request.amount.toFixed(2)) }}
            </td>
            <td class="px-1">
              <span
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <div class="d-flex gap-1">
                        <div v-if="payment_request.user_can_approve && !payment_request.user_has_approved">
                          <button
                        ...
                        <div class="" v-if="payment_request.user_can_approve && !payment_request.user_has_approved">
                          <button
                    ...
                    <div class="modal-body">
                      <div class="row mb-1">
                        <div class="col-6 my-1">{{ $t('Vendor') }}</div>
                        <div class="col-6">
                          <a
                        ...
                        <div class="col-6 my-1">Discount Rate (%) (including Base Rate)</div>
...
export default {
  ...
  setup(props) {
    ...
    const getRequests = async () => {
      await axios
        .get(base_url + props.bank + '/requests/vendor-financing-requests/data', {
          params: {
    ...
    const exportReport = () => {
      axios
        .get(base_url + props.bank + '/requests/portfolio/export', {
          ...
          method: 'GET',
          params: {
            type: 'Vendor Financing Receivable',
            invoice_number: invoice_number_search.value,
            status: status_search.value,
            payment_reference_number: payment_reference_number_search.value,
            invoice_number: invoice_number_search.value,
    ...
    const updateStatus = (payment_request, status) => {
      ...
      axios
        ...
        .then(() => {
          toast.success('Vendor Financing Request updated successfully');
          getRequests();
          if (status == 'rejected') {
