<template>
  <div class="card p-1">
    <div class="d-flex justify-content-between">
      <h5 class="card-header px-1">{{ $t('Latest Factoring Requests') }}</h5>
      <a class="card-header text-primary text-decoration-underline" :href="bank_url + '/requests/factoring'">{{
        $t('View All')
      }}</a>
    </div>
            ...
            <td class="px-1">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="modalCenterTitle">{{ $t('Factoring Request') }}</h5>
              ...
              >
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="modalCenterTitle">{{ $t('Approve Factoring Request') }}</h5>
                      <button
                        type="button"
                        class="btn-close"
                    ...
                    <form @submit.prevent="updateStatus(payment_request, 'approved')" method="post">
                      <div class="modal-body">
                        <h5>
                          {{ $t('Are you sure you want to approve the Factoring request with the reference number, ') }}
                          {{ payment_request.reference_number }}?
                        </h5>
                      </div>
                      <div class="modal-footer">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="modalCenterTitle">
                        {{ $t('Reject Factoring Request with the reference number, ') }}
                        {{ payment_request.reference_number }}
                      </h5>
                      <button
                        type="button"
...
export default {
  ...
  setup(props) {
    ...
    const getRequests = async () => {
      await axios
        .get(base_url + props.bank + '/requests/factoring-requests/data?per_page=' + per_page.value + '&type=dashboard')
        .then(response => {
