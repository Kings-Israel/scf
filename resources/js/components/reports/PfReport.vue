<template>
  <div class="card p-2" id="companies">
    <div class="d-flex justify-content-between">
      <div class="d-flex">
        <div class="mb-2">
          <input type="text" class="form-control" v-model="anchor" placeholder="Payment / OD Account No." />
        </div>
        <div class="mx-1">
          <input type="text" class="form-control" v-model="vendor" placeholder="Anchor" />
        </div>
        <div class="mx-1">
