    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
      <div class="d-flex flex-wrap gap-1">
        ...
        <div class="">
          ...
          <input type="text" class="form-control" placeholder="Vendor" v-model="vendor" v-on:keyup.enter="filter" />
        </div>
        <div class="">
          ...
          <input
            ...
            name="vf-overdue-report-payment-daterange"
        ...
        <div class="">
          ...
          <input
            ...
            id="due_date_search"
            class="form-control form-search"
            name="vf-overdue-report-due-daterange"
            placeholder="Select Dates"
            autocomplete="off"
          />
        </div>
        <div class="">
          ...
          <select class="form-select" id="exampleFormControlSelect1" v-model="dpd">
            <option value="">{{ $t('DPD') }}</option>
            <option value="1-5">1 - 5 {{ $t('Days') }}</option>
            <option value="6-10">6 - 10 {{ $t('Days') }}</option>
            <option value="10">More than 10 {{ $t('Days') }}</option>
          </select>
        </div>
        <div class="">
...
export default {
  ...
  setup(props) {
      ...
      await axios
        .get(base_url + props.bank + '/reports/data', {
          params: {
            ...
            type: 'vf-overdue-invoices-report'
          }
        })
        .then(response => {
    ...
    const refresh = async () => {
      ...
      from_due_date_search.value = '';
      to_due_date_search.value = '';
      dpd.value = '';
      status.value = '';
      sort_by.value = '';
    ...
    const downloadReport = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute('download', `VF_overdue_invoices_report_${moment().format('Do_MMM_YYYY')}.csv`);
    ...
    const downloadPdf = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.href = fileURL;
          fileLink.setAttribute('download', `VF_overdue_invoices_Report_${moment().format('Do_MMM_YYYY')}.pdf`);
          document.body.appendChild(fileLink);
