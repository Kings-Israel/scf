    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
      <div class="d-flex flex-wrap gap-1">
        ...
        <!-- <div class="">
          ...
          <input type="text" class="form-control form-search" placeholder="Anchor" v-model="anchor" />
        </div> -->
        <div class="">
        ...
        <div class="">
          ...
          <input
            ...
            class="form-control form-search"
            name="vf-fees-and-interest-sharing-report-payment-daterange"
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr v-for="report in report_data.data" :key="report.id">
            <td>
              <a v-if="report.buyer_id" :href="'../companies/' + report.anchor_id + '/details'">{{ report.anchor }}</a>
              <a :href="'../companies/' + report.company_id + '/details'" v-else>
                {{ report.company }}
              </a>
            </td>
            <td
            ...
            <td class="text-success">
              {{ new Intl.NumberFormat().format(report.anchor_discount_bearing_amount) }}
            </td>
            <td class="text-success">{{ new Intl.NumberFormat().format(report.program_fees) }}</td>
            <td class="text-success">
              {{ new Intl.NumberFormat().format(report.anchor_fee_bearing_amount) }}
            </td>
            <td>
      ...
      await axios
        .get(base_url + props.bank + '/reports/data', {
          params: {
            ...
            type: 'vf-fees-and-interest-sharing-report'
          }
        })
        .then(response => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute(
            'download',
            `VF_fees_charges_and_interest_sharing_report_${moment().format('Do_MMM_YYYY')}.csv`
          );
    ...
    const downloadPdf = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute(
            'download',
            `VF_fees_and_interest_sharing_Report_${moment().format('Do_MMM_YYYY')}.pdf`
          );
          document.body.appendChild(fileLink);
