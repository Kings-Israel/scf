<template>
  <div class="card p-2" id="companies">
    <div class="d-flex justify-content-between">
      <div class="d-flex">
        <div class="mb-2">
          <input type="text" class="form-control" placeholder="Payment/OD Account" />
        </div>
        <div class="mx-1">
          <input type="text" class="form-control" placeholder="Dealer" />
        </div>
        <div class="mx-1">
          <input type="text" class="form-control" placeholder="Anchor" />
        </div>
        <div class="mx-1">
          <input class="form-control" type="date" id="html5-date-input" />
        </div>
        <div class="mx-1">
          <button class="btn btn-primary"><i class="ti ti-refresh ti-sm"></i></button>
        </div>
      </div>
      <div class="d-flex justify-content-end">
        ...
        <div class="mx-2">
          <button type="button" class="btn btn-primary" title="Download Excel" @click="downloadReport" style="height: fit-content;"><i class='ti ti-file-spreadsheet ti-xs'></i></button>
          <button type="button" class="btn btn-primary mx-1" title="Doanload PDF" @click="downloadPdf" style="height: fit-content;"><i class='ti ti-file-text ti-xs'></i></button>
        </div>
      </div>
    </div>
    <div class="table-responsive">
      <table class="table">
        <thead>
          <tr class="">
            <th>Payment/OD Account</th>
            <th>Anchor</th>
            <th>Dealer</th>
            <th>Cash Collateral (Ksh)</th>
            <th>PF Entry (Ksh)</th>
            <th>Total Debit (Ksh)</th>
            <th>Balance (Ksh)</th>
