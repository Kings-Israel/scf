    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
      <div class="d-flex flex-wrap gap-1">
        <div class="">
          ...
          <input type="text" class="form-control" v-model="vendor" placeholder="Dealer" v-on:keyup.enter="filter" />
        </div>
        <!-- <div class="">
      ...
      await axios
        .get(base_url + props.bank + '/reports/data', {
          params: {
            ...
            type: 'dealers-daily-outstanding-balance-report'
          }
        })
        .then(response => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute(
            'download',
            `Dealers_daily_outstanding_balance_report_${moment().format('Do_MMM_YYYY')}.csv`
          );
    ...
    const downloadPdf = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute(
            'download',
            `Dealers_daily_outstanding_balance_Report_${moment().format('Do_MMM_YYYY')}.pdf`
          );
          document.body.appendChild(fileLink);
