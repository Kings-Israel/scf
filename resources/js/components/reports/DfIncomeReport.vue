      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr v-for="report in report_data.data" :key="report.id">
            ...
            <td class="text-success">{{ new Intl.NumberFormat().format(report.overdue) }}</td>
            <td>
              <span
    ...
    const downloadReport = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute('download', `DF_income_report_${moment().format('Do_MMM_YYYY')}.csv`);
    ...
    const downloadPdf = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.href = fileURL;
          fileLink.setAttribute('download', `DF_income_report_${moment().format('Do_MMM_YYYY')}.pdf`);
          document.body.appendChild(fileLink);
