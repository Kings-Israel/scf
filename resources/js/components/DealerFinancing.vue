    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
      <div class="d-flex flex-wrap gap-1">
        ...
        <div class="">
          ...
          <input class="form-control form-search" type="text" name="request_daterange" id="date_search" />
        </div>
        <div class="">
          ...
          <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">{{ $t('Approve Dealer Financing Request(s)') }}</h5>
                <button
                  type="button"
                  class="btn-close"
              ...
              <form method="post" @submit.prevent="submitBulkAction('approve')">
                <div class="modal-body">
                  <div class="">
                    <h4>{{ $t('Are you sure you want to approve the selected Dealer Financing requests') }}?</h4>
                  </div>
        ...
        <div class="modal fade" id="bulk-rejection-modal" tabindex="-1" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">{{ $t('Reject Dealer Financing Request(s)') }}</h5>
                <button
                  type="button"
                  class="btn-close"
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="modalCenterTitle">
                        {{
                          $t(
                            'Reject Dealer Financing Request with reference number, ' + payment_request.reference_number
                          )
                        }}
                      </h5>
                      <button
...
export default {
  ...
  setup(props) {
    ...
    const getRequests = async () => {
      await axios
        .get(base_url + props.bank + '/requests/dealer-financing-requests/data?per_page=' + per_page.value, {
          params: {
