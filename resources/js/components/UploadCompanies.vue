<template>
  <div class="">
    <button data-bs-toggle="modal" data-bs-target="#uploadCompanies" class="btn btn-primary btn-sm">
      {{ $t('Upload Companies') }}
    </button>
  </div>
  <div class="modal modal-top fade" id="uploadCompanies" tabindex="-1">
    <div class="modal-dialog">
      <form
        ...
        @submit.prevent="uploadCompanies()"
      >
        <div class="modal-header">
          <h5 class="modal-title" id="modalTopTitle">{{ $t('Upload Companies') }}</h5>
          <button
            type="button"
            class="btn-close"
        ...
        <div class="modal-body">
          ...
          <a
            :href="'companies/upload/error-report/download'"
        ...
        <div class="modal-footer">
          <a :href="'companies/template/download'" id="download-invoices" class="btn btn-label-warning">{{
            $t('Download Sample')
          }}</a>
...
export default {
  ...
  setup(props) {
    ...
    const uploadCompanies = () => {
      ...
      formData.append('file', invoices_file.value);

      axios
        .post(base_url + props.bank + '/companies/import', formData)
        .then(response => {
