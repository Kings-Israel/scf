<template>
  <div class="card p-2">
    <div class="d-flex justify-content-between">
      ...
      <div class="d-flex justify-content-end flex-wrap gap-1 mt-auto">
        <div class="">
      ...
      <table class="table">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr v-for="payment in report.data" :key="payment.id">
            <td>{{ payment.anchor.name }} ({{ payment.payment_account_number }})</td>
            <td>
...
export default {
  ...
  setup(props, context) {
    ...
    const exportPdfReport = () => {
      ...
      axios
        .get(base_url + 'reports/report/' + type.value + '/pdf/export', {
          responseType: 'arraybuffer',
          method: 'GET',
          params: {
            vendor: vendor.value
