    ...
    <div class="card-body">
      <div class="d-flex justify-content-between">
        <div class="d-flex flex-wrap gap-1">
          <div class="">
            <label for="PO Number" class="form-label">{{ $t('Anchor') }}</label>
            <input
              type="text"
          ...
          <div class="">
            ...
            <select class="form-select form-search" id="exampleFormControlSelect" v-model="status_search">
              ...
              <option value="rejected">{{ $t('Rejeccted') }}</option>
            </select>
          </div>
          <div class="" v-if="can_edit == 1">
          ...
          <button
            ...
            v-if="can_edit == 1"
          ></button>
          <div class="modal fade" id="bulk-approval-modal" tabindex="-1" aria-hidden="true" v-if="can_ecit == 1">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="modalCenterTitle">{{ $t('Approve POs') }}</h5>
                  <button
                    type="button"
                    class="btn-close"
          ...
          <button
            ...
            v-if="can_edit == 1"
          ></button>
          <div class="modal fade" id="bulk-rejection-modal" tabindex="-1" aria-hidden="true" v-if="can_edit == 1">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
              <div class="modal-content">
                <div class="modal-header">
        ...
        <table class="table dt-invoices">
          ...
          <tbody>
            ...
            >
              ...
              <td class="text-success text-nowrap">{{ new Intl.NumberFormat().format(purchase_order.total) }}</td>
              <td class="">{{ purchase_order.purchase_order_items.length }}</td>
              ...
              <td>
                <span class="badge py-2 mt-1" :class="resolveStatus(purchase_order.approval_stage)">{{
                ...
                <div class="d-inline-block">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end m-0">
                    <li
                      ...
                      data-bs-toggle="modal"
                      style="cursor: pointer"
                      @click="submitApproval(purchase_order, 'approve')"
                    >
                    ...
                    >
                      <a
                        :href="'purchase-orders/' + purchase_order.id + '/reject'"
                        class="dropdown-item badge bg-label-danger"
                        >{{ $t('Reject') }}</a
                      >
                    </li>
                    <li class="dropdown-item badge bg-label-secondary">{{ $t('View Attachment') }}</li>
                  </ul>
                </div>
              </td>
              <td>
...
export default {
  ...
  setup(props) {
    ...
    const getPurchaseOrders = async () => {
      await axios
        .get(base_url + 'purchase-orders/data?per_page=' + per_page.value)
        .then(response => {
    ...
    const submitApproval = async (purchase_order, status) => {
      await axios
        .post(`${base_url}purchase-orders/approve`, {
    ...
    watch([per_page], ([per_page]) => {
      axios
        .get(base_url + 'purchase-orders/data?per_page=' + per_page, {
          params: {
