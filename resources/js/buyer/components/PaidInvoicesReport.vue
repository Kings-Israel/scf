  ...
  <div class="card p-2">
    <div class="d-flex justify-content-between">
      <div class="d-flex flex-wrap gap-1">
        ...
        <div class="">
          <label for="Financing Status" class="form-label mx-1">{{ $t('Financing Status') }}</label>
      ...
      <div class="d-flex justify-content-md-end gap-1 mt-2 mt-md-auto gap-1">
        <div class="">
    ...
    const exportReport = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute('download', `Paid_Invoices_${moment().format('Do_MMM_YYYY')}.csv`);
