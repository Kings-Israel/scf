<template>
  <div>
    <h5 class="fw-bold py-3 mb-2 d-flex flex-column">
      <span class="fw-light px-3">Discounting</span>
      <small class="px-3">Auto - All anchor approved invoices will be sent to bank automatically</small>
    </h5>
    <div class="row px-3 mb-2" v-for="program in programs" :key="program.id">
      ...
      <div class="col-md-4">
        <div class="form-check form-switch mb-2">
          <label class="form-check-label no-label" for="flexSwitchCheckChecked">Auto</label>
          ...
          <label class="form-check-label yes-label" for="flexSwitchCheckChecked">Manual</label>
        </div>
      </div>
    </div>
  </div>
