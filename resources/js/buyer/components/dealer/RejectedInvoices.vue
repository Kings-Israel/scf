      ...
      <div class="d-flex justify-content-between">
        <div class="d-flex flex-wrap">
          ...
          <div class="mx-1 d-none">
            ...
            <select class="form-select mx-1 form-search" id="exampleFormControlSelect">
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr v-show="invoices.data.length > 0" v-for="invoice in invoices.data" :key="invoice.id">
              ...
              <td>
                <a :href="'initiate-drawdown/' + invoice.id" class="btn btn-sm btn-primary">{{ $t('Re-Initiate') }}</a>
              </td>
              <td>
                <button
                  class="d-none"
...
export default {
  ...
  setup() {
    ...
    const getInvoices = async () => {
      await axios
        .get(base_url + 'reports/rejected-invoices/data', {
          params: {
