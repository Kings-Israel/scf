<template>
  <div class="card p-2">
    <div class="d-flex justify-content-between">
      ...
      <div class="d-flex flex-wrap justify-content-end gap-1 mt-auto">
        <div class="">
      ...
      <table class="table">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr v-for="invoice in report.data" :key="invoice.id">
            ...
            <td class="text-success text-nowrap">{{ invoice.currency }}.{{ new Intl.NumberFormat().format(invoice.balance) }}</td>
    ...
    const exportReport = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute('download', `Overdue_Invoices_${moment().format('Do_MMM_YYYY')}.csv`);
