...
export default {
  ...
  setup(props, context) {
    ...
    const getInvoices = async () => {
      await axios
        .get(base_url + 'invoices/uploaded/data', {
          params: {
    ...
    const exportInvoices = () => {
      axios
        .get(base_url + 'invoices/uploaded/export', {
        ...
        .then(response => {
          ...
          fileLink.setAttribute('download', `Uploaded_Invoices_${moment().format('Do_MMM_YYYY')}.csv`);
