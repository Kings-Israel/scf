<template>
  <div class="modal fade" v-if="invoice_details" :id="'pi-' + invoice_details.id" tabindex="-1" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="d-flex flex-column flex-md-row justify-content-md-between mb-4">
            ...
            <div class="mb-md-3">
              <span v-if="invoice_details.pi_number" class="d-flex flex-column flex-md-row justify-content-between">
          ...
          <div v-if="invoice_details.invoice_fees.length > 0" class="px-2">
            <span v-for="fee in invoice_details.invoice_fees" :key="fee.id" class="d-flex justify-content-end">
              ...
              <h5
                ...
                v-if="fee.name != 'Credit Note Amount' && fee.name != 'Credit Note' && fee.name != 'Credit Amount'"
              >
                ({{
                  getTaxPercentage(
          ...
          <div class="bg-label-secondary px-md-2">
            <span class="d-flex justify-content-end">
