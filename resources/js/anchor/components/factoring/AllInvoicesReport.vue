      ...
      <table class="table">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr v-for="invoice in invoices.data" :key="invoice.id">
            ...
            <td>
              <span class="me-1">{{ invoice.buyer }}</span>
            </td>
            ...
            <td
              ...
              v-if="invoice.financing_status == 'financed' || invoice.financing_status == 'closed'"
            >
...
export default {
  ...
  setup(props, context) {
    ...
    const getReport = async () => {
      await axios
        .get(base_url + 'factoring/reports/all-invoices-report', {
          params: {
    ...
    const exportReport = () => {
      ...
      axios
        .get(base_url + 'factoring/reports/report/factoring-all-invoices-report/export', {
    ...
    const exportPdfReport = () => {
      ...
      axios
        .get(base_url + 'reports/factoring-all-invoices-report/pdf/export', {
          responseType: 'arraybuffer',
          method: 'GET',
          params: {
            invoice_number: invoice_number_search.value,
