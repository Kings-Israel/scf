    ...
    <div class="d-flex justify-content-between px-2 py-2">
      <div class="d-flex flex-wrap">
        ...
        <div class="mx-1">
          ...
          <select class="form-select form-search" v-model="status_search" id="form-search">
            <option value="">{{ $t('Status') }}</option>
            <option value="pending">{{ $t('Pending') }}</option>
            <option value="approved">{{ $t('Accepted') }}</option>
        ...
        <div class="mx-1">
          ...
          <select class="form-select form-search" v-model="bulk_action" id="form-search">
        ...
        <div class="my-auto">
          <button class="btn btn-primary btn-sm mx-1" title="Download Excel" type="button" @click="filter">
            <i class="ti ti-search"></i>
          </button>
          <button class="btn btn-primary btn-sm" title="Download PDF" type="button" @click="refresh">
        ...
        <tbody>
          ...
          >
            ...
            <td class="">
              <div class="d-inline-block">
                ...
                <ul class="dropdown-menu dropdown-menu-end m-0">
                  ...
                  <li
                    class=""
                    v-if="purchase_order.status == 'accepted' && purchase_order.approval_stage != 'Invoiced'"
                  >
                    <a
            ...
            <td>
              <div
                class="modal fade"
                :id="'reject-purchase-order-' + purchase_order.id"
                tabindex="-1"
                aria-hidden="true"
              >
                  ...
                  <form @submit.prevent="submitApproval(purchase_order.id, 'rejected')">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" type="submit" :disabled="!can_submit">
                          {{ $t('Submit') }}
                        </button>
                      </div>
                    </div>
...
export default {
  ...
  setup() {
    ...
    const getPurchaseOrders = async () => {
      await axios
        .get(base_url + 'factoring/purchase-orders/pending/data?per_page=' + per_page.value)
        .then(response => {
    ...
    const submitApproval = async (purchase_order, status) => {
      ...
      await axios
        .post(`${base_url}factoring/purchase-orders/status/update`, {
    ...
    const exportReport = () => {
      axios
        .get(base_url + 'purchase-orders/data/export', {
