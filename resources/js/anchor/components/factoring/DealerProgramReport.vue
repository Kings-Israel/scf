  ...
  <div class="card p-2">
    <div class="d-flex justify-content-between">
      ...
      <div class="d-flex align-items-end">
        ...
        <button type="button" @click="exportReport" class="btn btn-primary btn-sm mx-1" title="Download Excel">
          <i class="ti ti-file-spreadsheet ti-xs"></i>
        </button>
        <button type="button" @click="exportPdfReport" class="btn btn-primary btn-sm" title="Download PDF">
...
export default {
  ...
  setup(props, context) {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.setAttribute(
            'download',
            `Dealer_Programs_${moment().format('Do_MMM_YYYY')}.csv`,
          )
    ...
    const filter = () => {
      ...
      axios
        .get(base_url + 'factoring/reports/dealer-programs-report', {
          params: {
            per_page: per_page.value,
    ...
    const exportReport = () => {
      axios
        .get(base_url + 'factoring/reports/report/factoring-dealer-program-report/export', {
    ...
    const exportPdfReport = () => {
      axios
        .get(base_url + 'reports/factoring-dealer-program-report/pdf/export', {
          responseType: 'arraybuffer',
          method: 'GET'
        })
        .then(response => {
