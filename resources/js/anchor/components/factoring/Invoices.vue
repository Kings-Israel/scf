              ...
              <div class="d-inline-block">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <li
                    ...
                    @click="showInvoice(invoice.id, 'show-approve-btn-' + invoice.id)"
                  >
...
export default {
  ...
  setup(props, context) {
    ...
    const getInvoices = async () => {
      await axios
        .get(base_url + 'factoring/invoices/data', {
          params: {
    ...
    const submitApproval = async invoice => {
      ...
      await axios
        .post(`${base_url}factoring/invoices/${invoice.id}/approve`, formData)
        .then(() => {
          getInvoices();
    ...
    const approveFees = async invoice => {
      await axios
        .get(`${base_url}factoring/invoices/${invoice.id}/fees/approve`)
        .then(() => {
          getInvoices();
          toast.success('Invoice updated successfully');
    ...
    const requestApproval = async (invoice, status) => {
      ...
      await axios
        .post(base_url + 'factoring/invoices/' + invoice.id + '/request/send', formData)
        .then(() => {
          toast.success('Invoice updated successfully');
          getInvoices();
        })
    ...
    const selectAll = () => {
      ...
      if (selected_invoices.value.length > 0) {
        ...
        axios.post(base_url + 'invoices/bulk/details?type=Factoring', formData).then(response => {
    ...
    const submitBulkApproval = () => {
      ...
      axios
        .post(base_url + 'invoices/bulk/update/approve?type=Factoring', formData)
        .then(res => {
          getInvoices();
    ...
    const submitBulkRejection = () => {
      ...
      axios
        .post(base_url + 'invoices/bulk/update/reject?type=Factoring', formData)
        .then(() => {
          getInvoices();
