    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
      <div class="d-flex flex-wrap gap-1">
        ...
        <div class="">
          ...
          <select class="form-select form-search" id="exampleFormControlSelect" v-model="financing_status">
      ...
      <table class="table">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr v-for="invoice in report.data" :key="invoice.id">
            ...
            <td>
              <span class="badge me-1 m_title" :class="resolveStatus(invoice)">{{
                invoice.days_past_due > 0 ? 'Overdue' : invoice.status
              }}</span>
            </td>
            <td>
            ...
            <td v-else>-</td>
            <td v-if="invoice.disbursement_date">{{ invoice.transaction_ref }}</td>
            <td v-else>-</td>
            <td>
              <button
                class="d-none"
...
export default {
  ...
  setup(props, context) {
    ...
    const exportReport = () => {
      ...
      axios
        .get(base_url + 'reports/report/paid-invoices/export', {
        ...
        .then(response => {
          ...
          fileLink.setAttribute('download', `Paid_invoices_report_${moment().format('Do_MMM_YYYY')}.csv`);
    ...
    const exportPdfReport = () => {
      ...
      axios
        ...
        .then(response => {
          ...
          fileLink.href = fileURL;
          fileLink.setAttribute('download', `Paid_Invoices_${moment().format('Do_MMM_YYYY')}.pdf`);
          document.body.appendChild(fileLink);
