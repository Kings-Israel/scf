    ...
    <div class="d-flex flex-column flex-md-row justify-content-between">
      <div class="d-flex flex-wrap gap-1">
        ...
        <div class="">
          ...
          <select class="form-select form-search" id="form-search" v-model="status_search">
        ...
        <div class="">
          ...
          <select class="form-select form-search" id="form-search" v-model="financing_status_search">
            <option value="">{{ $t('Status') }}</option>
            <option value="pending">{{ $t('Pending') }}</option>
      ...
      <div class="d-flex justify-content-md-end flex-wrap gap-1 mt-2 mt-md-auto">
        ...
        <button type="button" @click="exportReport" class="btn btn-primary">
          <span class="d-flex" v-if="!downloadingExcel"> <i class="ti ti-download px-1"></i> {{ $t('Excel') }} </span>
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr v-for="invoice in report.data" :key="invoice.id">
            ...
            <td
              ...
              @click="showInvoice(invoice.id, 'show-invoice-' + invoice.id)"
...
export default {
  ...
  setup(props, context) {
    ...
    const exportPdfReport = () => {
      ...
      axios
        .get(base_url + 'reports/all-invoices/pdf/export', {
          responseType: 'arraybuffer',
          method: 'GET'
        })
        .then(response => {
