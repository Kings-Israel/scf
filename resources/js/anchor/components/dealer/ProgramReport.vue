      ...
      <table class="table">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr v-for="program in programs.data" :key="program.id">
            ...
            <td>
              <span class="me-1">{{ program.buyer_name }}</span>
            </td>
...
export default {
  ...
  setup(props, context) {
    ...
    const getPrograms = () => {
      axios
        .get(base_url + 'factoring/reports/programs-report', {
          params: {
    ...
    const exportReport = () => {
      axios
        .get(base_url + 'factoring/reports/report/factoring-program-report/export', {
        ...
        .then(response => {
          ...
          fileLink.setAttribute('download', `Programs_${moment().format('Do_MMM_YYYY')}.xlsx`);
    ...
    const exportPdfReport = () => {
      axios
        .get(base_url + 'reports/factoring-program-report/pdf/export', {
          responseType: 'arraybuffer',
          method: 'GET'
        })
        .then(response => {
