<template>
  <div class="card">
    ...
    <div class="card-body">
      <div class="d-flex flex-column flex-md-row justify-content-between" v-if="!is_dashboard">
        ...
        <div class="d-flex mx-md-2" style="height: fit-content">
          <select class="form-select mx-md-2" id="exampleFormControlSelect1" v-model="per_page">
      ...
      <div class="table-responsive">
        <table class="table invoices-table">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div
                            class="col-6"
                            v-if="
                              invoice_details.program.discount_details.length > 0 &&
                              invoice_details.program.discount_details[0].discount_type == 'Front Ended'
                            "
                          >
                            <div class="border-bottom d-flex justify-content-between">
          ...
          <tfoot v-if="!is_dashboard" class="text-nowrap">
            <tr>
              <td></td>
              <td></td>
              <td></td>
  ...
  setup(props) {
    ...
    const formatNoa = invoice => {
      ...
      if (noa_text.value) {
        ...
        new_text = new_text.replace('{buyerName}', '');
        ...
        new_text = new_text.replace(
          '{anchorAddress}',
          invoice.program.anchor.address + ' ' + invoice.program.anchor.postal_code + ' ' + invoice.program.anchor.city
        );
        new_text = new_text.replace(
          '{penalnterestRate}',
