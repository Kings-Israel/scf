    ...
    <div class="card-body">
      <div class="d-flex justify-content-between">
        <div class="d-flex flex-wrap">
          ...
          <div class="mx-1">
            <label for="Pi Number" class="form-label">PI No.</label>
            <input
              type="text"
              class="form-control form-search"
              id="defaultFormControlInput"
...
export default {
  ...
  setup() {
    ...
    const getInvoices = async () => {
      await axios
        .get(base_url + 'invoices/payments/data', {
          params: {
    ...
    watch(
      [anchor_search, invoice_number_search, paid_date_search, pi_number_search, per_page],
      async ([anchor_search, invoice_number_search, paid_date_search, pi_number_search, per_page]) => {
        await axios
          .get('invoices/payments/data', {
            params: {
              per_page: per_page,
              anchor: anchor_search,
              invoice_number: invoice_number_search,
              paid_date: paid_date_search,
              pi_number: pi_number_search
            }
          })
          .then(response => {
            invoices.value = response.data;
