...
class RequestToUnblock extends Mailable
{
  ...
  {
    $this->template = EmailTemplate::where('name', 'Request To Unblock')->first();
  ...
  public function envelope()
  {
    ...
    if ($this->template) {
      ...
      $subject = $this->company->name . ' requested to be unblocked.';
    }
  ...
  public function content()
  {
    ...
    return new Content(
      markdown: 'content.email.request-to-unblock',
      with: [
