...
class PartialRepayment extends Mailable
{
  ...
  {
    $this->template = EmailTemplate::where('name', 'Partial Repayment')->first();
  }
  ...
  public function content()
  {
    ...
    $data['amount'] = $this->invoice->paid_amount;
    $data['balance_amount'] = $this->invoice->balance;
    ...
    return new Content(
      markdown: 'content.bank.email.partial-repayment',
      with: [
