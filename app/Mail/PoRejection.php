...
class PoRejection extends Mailable
{
  ...
  {
    $this->template = EmailTemplate::where('name', 'PO Rejection')->first();
  ...
  public function envelope(): Envelope
  {
    ...
    if ($this->template) {
      ...
      $subject = 'PO Rejected by ' . $this->purchase_order->company->name;
    }
  ...
  public function content()
  {
    ...
    $data['rejection_reason'] = $this->purchase_order->rejection_reason;
    ...
    return new Content(
      markdown: 'content.email.po-rejection',
      with: [
