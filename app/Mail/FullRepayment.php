...
class FullRepayment extends Mailable
{
  ...
  {
    $this->template = EmailTemplate::where('name', 'Full Repayment')->first();
  }
  ...
  public function content()
  {
    ...
    return new Content(
      markdown: 'content.bank.email.full-repayment',
      with: [
