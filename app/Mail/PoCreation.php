...
class PoCreation extends Mailable
{
  ...
  {
    $this->template = EmailTemplate::where('name', 'PO Creation')->first();
  ...
  public function envelope()
  {
    ...
    if ($this->template) {
      ...
      $subject = 'New PO created by ' . $this->purchase_order->anchor->name;
    }
  ...
  public function content()
  {
    ...
    return new Content(
      markdown: 'content.email.po-creation',
      with: [
