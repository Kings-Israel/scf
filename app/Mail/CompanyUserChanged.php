...
class CompanyUserChanged extends Mailable
{
  ...
  {
    $this->template = EmailTemplate::where('name', 'Company User Changed')->first();
  }
  ...
  public function envelope()
  {
    ...
    if ($this->template) {
      ...
      $subject = 'Company User ' . $this->user->name . ' changed';
    }
  ...
  public function content()
  {
    ...
    return new Content(
      markdown: 'content.bank.email.company-user-changed',
      with: [
