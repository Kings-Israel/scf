<?php
  // Variables
  return [
    "creatorName" => "YoFinvoice",
    "creatorUrl" => "https://yofinvoice.com",
    "templateName" => "YoFinvoice",
    "templateSuffix" => "YoFInvoice Dashboard",
    "templateVersion" => "1.0.0",
    "templateFree" => false,
    "templateDescription" => "YoFinvoice Dashboard",
    "templateKeyword" => "YoFinvoice Dashboard",
